...
<body>
    ...
    <header>
        ...
        <div id="centro">
            <img id="fotoPerfil" src="imagenes/perfil/image (15).png">
            <h1>Jero, dev</h1>
        </div>
    </header>
    ...
    <main>
        <div id="logos">
            ...
            <svg style="animation-delay: 0.4s;" viewBox="0 0 73 73" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div id="informacion">
            <h2>Sobre Mí: </h2>
            <p>Soy un desarrollador en formación apasionado por la tecnología y la programación. Me gusta aprender
                constantemente, crear soluciones a problemas reales y mejorar mis habilidades en desarrollo de software.
                Disfruto experimentar con nuevas herramientas, desarrollar proyectos propios y seguir creciendo como
                programador.</p>

            <div id="both">
                <label for="correo">Correo: </label>
                <h2 id="correo">JeroArbe@gmail.com</h2>
                <label for="nombre">Nombre: </label>
                <h2 id="nombre">Jeronimo Arbelaez</h2>
            </div>
        </div>
    </main>
